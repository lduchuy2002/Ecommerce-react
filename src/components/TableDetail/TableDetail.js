    ...
    <table className="table-detail">
      <tbody>
        <tr>
          ...
          <td className="right">
            {context !== undefined ? context.chip : <LazyLoad />}
          </td>
        </tr>
        <tr>
          <td className="left">RAM</td>
          <td className="right">
            {context !== undefined ? context.ram : <LazyLoad />}
          </td>
        </tr>
        <tr>
          <td className="left">Màn hình</td>
          <td className="right">
            {context !== undefined ? context.screen : <LazyLoad />}
          </td>
        </tr>
        <tr>
          <td className="left">Đồ họa</td>
          <td className="right">
            {context !== undefined ? context.card : <LazyLoad />}
          </td>
        </tr>
        <tr>
          <td className="left">Audio</td>
          <td className="right">
            {context !== undefined ? context.audio : <LazyLoad />}
          </td>
        </tr>
        <tr>
          <td className="left">Hệ điều hành</td>
          <td className="right">
            {context !== undefined ? context.win : <LazyLoad />}
          </td>
        </tr>
        <tr>
          <td className="left">PIN</td>
          <td className="right">
            {context !== undefined ? context.PIN : <LazyLoad />}
          </td>
        </tr>
        <tr>
          <td className="left">Năm xuất xứ</td>
          <td className="right">
            {context !== undefined ? context.year : <LazyLoad />}
          </td>
        </tr>
        <tr>
          <td className="left">Bộ nhớ trong</td>
          <td className="right">
            {context !== undefined ? context.rom : <LazyLoad />}
          </td>
        </tr>
        <tr>
          <td className="left">Độ phân giải</td>
          <td className="right">
            {context !== undefined ? context.px : <LazyLoad />}
          </td>
        </tr>
        <tr>
